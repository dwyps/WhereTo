...
class HomePopularFragment : Fragment(R.layout.home_tab_recycler_view_fragment), HomeTripsRecyclerAdapter.OnItemListener  {
    ...
    private fun initRecyclerView() {
        ...
        home_tab_recycler_view.apply {
            ...
            homeRecyclerAdapter = HomeTripsRecyclerAdapter(this@HomePopularFragment)
