package com.example.whereto.ui.main.profile.tabs
...
class ProfileTravelledFragment : Fragment(R.layout.profile_tab_recycler_view_fragment), RecyclerAdapter.OnItemListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        profileViewModel.getTraveledList()
    ...
    private fun initRecyclerView() {
        ...
        profile_recycler_view.apply {
            ...
            profileRecyclerAdapter = RecyclerAdapter(this@ProfileTravelledFragment)
    ...
    override fun onItemClick(position: Int, trip: Trip) {
        ...
        findNavController().navigate(ProfileFragmentDirections.actionProfileFragmentToTripFragment(trip.name))
    }

    override fun onItemLongClick(position: Int, trip: Trip) {

        val options = arrayOf("Remove")
        ...
        AlertDialog.Builder(context)
            ...
            .setItems(options) {dialog, which ->
                ...
                when(which) {
                    ...
                    0 -> {
                        profileViewModel.setTravelled(trip.name, false)
                        profileRecyclerAdapter.notifyDataSetChanged()
                        dialog.cancel()
                    }
                }
